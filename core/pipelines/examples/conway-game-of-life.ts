import { InitializeConwayCells, StepConwayCells } from '@core/functors/conway-game-of-life';
import type { PipelineArgs, PipelineDefinition } from '@core/types'

import { LinkSymbols } from '@core/functors/common';

export const conwayGame: PipelineDefinition = {
  id: 'conway-game-of-life',
  label: "Conway's Game of Life",
  description: "Run Conway's Game of Life simulation over a fixed number of iterations.",
  args: {
    required: ['steps'],
